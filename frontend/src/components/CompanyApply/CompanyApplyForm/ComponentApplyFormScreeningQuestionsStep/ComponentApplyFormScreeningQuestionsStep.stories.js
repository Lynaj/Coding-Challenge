...
import ComponentApplyFormScreeningQuestionsStep from './ComponentApplyFormScreeningQuestionsStep'
import Vue from 'vue'
...
storiesOf('ComponentApplyFormScreeningQuestionsStep', module)
  .add('Fully Working', () => {
    return {
      components: { ComponentApplyFormScreeningQuestionsStep },
      template: `<component-apply-form-screening-questions-step />`,
      data: () => ({ })
    }
  }
  )
