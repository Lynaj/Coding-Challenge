...
import ClientApplyFormFirstStep from './ClientApplyFormFirstStep'
import Vue from 'vue'
...
storiesOf('ClientApplyFormFirstStep', module)
  .add('Fully Working', () => {
    return {
      components: { ClientApplyFormFirstStep },
      template: `<client-apply-form-first-step :tableObject="local_test_item" />`,
