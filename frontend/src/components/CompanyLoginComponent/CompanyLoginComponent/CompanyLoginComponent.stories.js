...
import CompanyLoginComponent from './CompanyLoginComponent'
import Vue from 'vue'
...
storiesOf('CompanyLoginComponent', module)
  .add('Fully Working', () => {
    return {
      components: { CompanyLoginComponent },
      template: `<company-login-component />`,
      data: () => ({ })
    }
  }
  )
